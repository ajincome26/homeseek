...
export const categories = [
  { id: 1, name: 'Cho thuê phòng trọ', code: 'CTPT', path: ROOM_FOR_RENT },
  { id: 2, name: 'Nhà cho thuê', code: 'NCT', path: HOUSE_FOR_RENT },
  { id: 3, name: 'Cho thuê căn hộ', code: 'CTCH', path: APARTMENT_FOR_RENT },
  { id: 4, name: 'Cho thuê mặt bằng', code: 'CTMB', path: GROUND_FOR_RENT },
  { id: 5, name: 'Tìm người ở ghép', code: 'TNOG', path: FIND_A_ROOMATE }
] as SearchItemType[]

export const prices = [
  { id: 1, name: 'Dưới 1 triệu', code: 'UOM', path: UNDER_ONE_MILLION },
  { id: 2, name: 'Từ 1 - 2 triệu', code: 'OTTM', path: FROM_ONE_TO_TWO_MILLION },
  { id: 3, name: 'Từ 2 - 3 triệu', code: 'TTTM', path: FROM_TWO_TO_THREE_MILLION },
  { id: 4, name: 'Từ 3 - 5 triệu', code: 'TTFM', path: FROM_THREE_TO_FIVE_MILLION },
  { id: 5, name: 'Từ 5 - 7 triệu', code: 'FTSM', path: FROM_FIVE_TO_SEVEN_MILLION },
  { id: 6, name: 'Từ 7 - 10 triệu', code: 'STTM', path: FROM_SEVEN_TO_TEN_MILLION },
  { id: 7, name: 'Từ 10 - 15 triệu', code: 'TTFI', path: FROM_TEN_TO_FIFTEEN_MILLION },
  { id: 8, name: 'Trên 15 triệu', code: 'OFM', path: OVER_FIFTEEN_MILLION }
] as SearchItemType[]
