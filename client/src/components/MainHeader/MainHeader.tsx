...
import { dataManage } from '~/constants/data'
  ...
  return (
    <div className='container flex items-center justify-between w-full py-3 mx-auto'>
      ...
      <div className='flex items-center gap-2'>
            ...
            >
              <div className='flex items-center gap-1'>
                <div className='relative flex items-center justify-center'>
                  ...
                  <Button
                    className='px-[14px] py-[8px] border-[2px] border-primary rounded-tl-none rounded-bl-none font-medium'
                    hover
                  >
                    Quản lý tài khoản
                  </Button>
        ...
        <Button to={isLoggedIn ? path.CREATE : path.LOGIN} className='p-2 text-white bg-secondary' hover>
