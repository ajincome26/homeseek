export const USERS_MESSAGES = {
  ...
  PHONE_NUMBER_LENGTH_MUST_BE_FROM_1_TO_100: 'Phone number length must be from 1 to 100',
...
export const POSTS_MESSAGES = {
  ...
  DESCRIPTION_IS_REQUIRED: 'Desc is required',
  DESCRIPTION_MUST_BE_A_STRING: 'Desc must be a string',
  DESCRIPTION_LENGTH_MUST_BE_FROM_1_TO_10000: 'Desc length must be from 1 to 10000',
  ...
  CATEGORY_LENGTH_MUST_BE_FROM_1_TO_100: 'Category length must be from 1 to 100',
  PRICE_IS_REQUIRED: 'Price is required',
  PRICE_LENGTH_MUST_BE_FROM_1_TO_20: 'Price length must be from 1 to 20',
  ACREAGE_IS_REQUIRED: 'Acreage is required',
  ACREAGE_LENGTH_MUST_BE_FROM_1_TO_20: 'Acreage length must be from 1 to 20',
  DEPOSIT_IS_REQUIRED: 'Deposit is required',
  DEPOSIT_LENGTH_MUST_BE_FROM_1_TO_20: 'Deposit length must be from 1 to 20',
  MEDIAS_MUST_BE_AN_ARRAY_OF_STRING: 'Medias must be an array of string',
  TARGET_IS_REQUIRED: 'Target is required',
  TARGET_MUST_BE_A_STRING: 'Target must be a string',
  TARGET_LENGTH_MUST_BE_FROM_1_TO_20: 'Target length must be from 1 to 20',
  CREATE_POST_SUCCESS: 'Create post successfully',
  GET_ALL_POST_SUCCESS: 'Get all post successfully'
} as const
