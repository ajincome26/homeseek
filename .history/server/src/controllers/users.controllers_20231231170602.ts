...
export const oauthController = async (req: Request, res: Response) => {
  ...
  const urlRedirect = `${process.env.CLIENT_REDIRECT_CALLBACK}?access_token=${result.access_token}&refresh_token=${
    result.refresh_token
  }&name=${result.user as ResponseMini}&new_user=${result.newUser}&verify=${result.verify}`
