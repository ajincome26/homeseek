      ...
      <div className='flex items-center gap-3 mt-3'>
        ...
        <div className='relative'>
          <select
            ...
            value={orderPrice}
            onChange={(e) => handleNavigatePrice(e.target.value as Exclude<PostListParams['orderAcreage'], undefined>)}
          >
        ...
        <div className='relative'>
          <select
            ...
            value={orderAcreage}
            onChange={(e) => handleNavigateAcreage(e.target.value as Exclude<PostListParams['orderPrice'], undefined>)}
          >
            <option value='' className='bg-white text-primary' disabled>
              Diện tích
            </option>
