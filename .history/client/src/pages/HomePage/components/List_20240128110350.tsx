...
const List = () => {
    ...
    return navigate({
      ...
      search: createSearchParams(
        omit(
          ...
          ['orderPrice', 'orderAcreage']
        )
      ).toString()
    })
  }
  const handleNavigatePrice = (orderValue: Exclude<PostListParams['orderAcreage' | 'orderPrice'], undefined>) => {
    return navigate({
      pathname: path.HOME,
      search: createSearchParams({
        ...queryParamsConfig,
  ...
  const handleNavigateAcreage = (orderValue: Exclude<PostListParams['orderPrice' | 'orderAcreage'], undefined>) => {
    return navigate({
      pathname: path.HOME,
      search: createSearchParams({
        ...queryParamsConfig,
