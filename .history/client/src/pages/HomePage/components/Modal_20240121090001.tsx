...
const Modal = ({ setIsShowModal, data, name, title, handleSubmit, queries, arrMinMax }: ModalProps) => {
  ...
  return (
    <div className='fixed top-0 left-0 z-10 w-full h-full bg-overlay-60 text-secondary' onClick={handleOnClick}>
      <div
        className='overflow-auto h-[470px] no-scrollbar w-[35%] bg-primary bg-opacity-[85] text-white relative left-1/2 top-[10%] translate-x-[-50%] rounded-lg'
        ref={nodeRef}
      >
        <div className='fixed relative flex items-center p-3 border-b border-gray-200'>
