...
const List = () => {
  ...
  const handleNavigatePrice = (orderValue: Exclude<PostListParams['orderAcreage'], undefined>) => {
    return navigate({
      pathname: path.HOME,
      search: createSearchParams({
        ...queryParamsConfig,
        ...
        orderAcreage: undefined
      }).toString()
    })
  }
  const handleNavigateAcreage = (orderValue: Exclude<PostListParams['orderPrice'], undefined>) => {
    return navigate({
      pathname: path.HOME,
      search: createSearchParams({
        ...queryParamsConfig,
