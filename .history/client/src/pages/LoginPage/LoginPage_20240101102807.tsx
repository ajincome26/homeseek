...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    const email = params.getAll()
    console.log('file: LoginPage.tsx:41 ~ useEffect ~ email:', email)
    ...
    if (access_token && refresh_token) {
      ...
      if (new_user == '1') toast.success('Đăng ký thành công', { autoClose: 2000 })
      else toast.success('Đăng nhập thành công', { autoClose: 2000 })
      navigate('/')
    }
  }, [navigate, params, setIsLoggedIn])
