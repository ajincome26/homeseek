...
export type FormReset = ResetPasswordSchema
interface FormResetPassword extends FormReset {
...
export default function ResetPassword() {
  ...
  const handleResetPassword = (data: FormReset) => {
    console.log('handleResetPassword ~ data:', data)
    // resetPasswordMutation.mutate(
    //   {
    //     forgot_password_token: location.state.forgot_password_token as string,
    ...
    //     onSuccess: (data) => {
    //       console.log(data)
    //       toast.success('Mật khẩu đã dược thay đổi thành công', { autoClose: 1000 })
    //     }
    //   }
    // )
  }
