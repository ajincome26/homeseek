  ...
  return (
    <div className='flex items-center justify-center px-5 py-8 xl:min-h-[85vh]'>
      <form
        ...
        className='relative flex flex-col w-full md:w-[60%] lg:w-[50%] xl:w-[40%] 2xl:w-[35%] min-h-full p-8 mx-auto rounded shadow-2xl bg-primary -z-10'
      >
        ...
        <div className='relative mt-5 text-center'>
          <span className='z-20 px-4 text-white bg-red-600'>OR</span>
          <div className='absolute h-[1px] w-full bg-white top-1/2 z-10'></div>
        </div>
        <Link to={'/'} className='flex items-center self-center justify-center w-20 h-10 mt-5 bg-red-300'>
          <FcGoogle size={25} />
        </Link>
      </form>
    </div>
