      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='w-1/2'>
          <Field>
            ...
            <input id='name' value={userInfo?.name || ''} className={`cr-input-text bg-[#c5d3f1]`} readOnly />
          </Field>
          <Field>
            <Label textColor='text-black' htmlFor='phone'>
              Điện thoại
            </Label>
            <input id='name' value={userInfo?.phone_number || ''} className={`cr-input-text bg-[#c5d3f1]`} readOnly />
          </Field>
          <Field>
