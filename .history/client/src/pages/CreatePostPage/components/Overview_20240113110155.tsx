    ...
    <div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <Field>
          ...
          <Input name='title' className='cr-input-text' register={register} relative />
        </Field>
        <Field>
          <Label textColor='text-black' htmlFor='desc'>
            Nội dung mô tả
          </Label>
          <InputArea name='description' id='desc' className='cr-input-text' register={register} relative />
        </Field>
        <div className='w-1/2'>
          <Field>
