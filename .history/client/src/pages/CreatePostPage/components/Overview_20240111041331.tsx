    ...
    <div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <Field>
          ...
          <Input
            className='focus:border-[#4b5fc2] hover:border-[#a0c7d6] cr-input-text mb-0 border-[2px] border-[#a0c7d6] outline-none rounded-md cr-transition box-border'
            register={register}
            name='title'
          />
        </Field>
        ...
        <div className='w-1/2'>
          <Field>
            ...
            <InputReadOnly id='username' data={''} />
          </Field>
        </div>
      </div>
    </div>
