...
const Overview = () => {
  ...
  const { register } = useForm<FormCreatePost>({
    ...
    <div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <Field>
          ...
          <Input className='cr-input-text' register={register} name='title' relative />
        </Field>
        <Field>
          <Label textColor='text-black' htmlFor='desc'>
            Nội dung mô tả
          </Label>
          <InputArea id='desc' className='cr-input-text' register={register} name='description' relative />
        </Field>
        <div className='w-1/2'>
          <Field>
