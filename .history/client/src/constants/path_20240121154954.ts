export const path = {
  ...
  UNDER_TWENTY_M2: '/under-twenty-m2',
  FROM_TWENTY_TO_THIRTY_M2: '/from-twenty-to-thirty-m2',
  FROM_THIRTY_TO_FIFTY_M2: '/from-thirty-to-fifty-m2',
  FROM_FIFTY_TO_SEVENTY_M2: '/from-fifty-to-seventy-m2',
  FROM_SEVENTY_TO_NINETY_M2: '/from-seventy-to-ninety-m2',
  OVER_NINETY_M2: '/over-ninety-to-m2',
