...
const {
  ...
  FROM_TEN_TO_FIFTEEN_MILLION,OVER_FIFTEEN_MILLION
} = path
...
export const prices = [
  { id: 1, name: 'Dưới 1 triệu', path:  },
  { id: 2, name: 'Từ 1 - 2 triệu' },
  { id: 3, name: 'Từ 2 - 3 triệu' },
  { id: 4, name: 'Từ 3 - 5 triệu' },
  { id: 5, name: 'Từ 5 - 7 triệu' },
  { id: 6, name: 'Từ 7 - 10 triệu' },
  { id: 7, name: 'Từ 10 - 15 triệu' },
  { id: 8, name: 'Trên 15 triệu' }
]
