...
export const areas = [
  ...
  { id: 3, name: 'Từ 30 - 50m2', path: FROM_TWO_TO_THREE_MILLION },
  { id: 4, name: 'Từ 50 - 70m2', path: FROM_THREE_TO_FIVE_MILLION },
  { id: 5, name: 'Từ 70 - 90m2', path: FROM_FIVE_TO_SEVEN_MILLION },
  { id: 8, name: 'Trên 90m2', path: OVER_FIFTEEN_MILLION }
] as SearchItemType[]
