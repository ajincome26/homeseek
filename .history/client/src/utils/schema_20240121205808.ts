...
export const postSchema = yup.object({
  ...
  subAddress: yup.string().max(50, 'Sub Address không được vượt quá 50 ký tự'),
  category: yup.string().max(200, 'Category không được vượt quá 200 ký tự'),
  price: yup.number().max(1000000000, 'Price không được vượt quá 1000000000'),
  acreage: yup.number().max(10000, 'Acreage không được vượt quá 10000'),
  deposit: yup.number().max(1000000000, 'Deposit không được vượt quá 1000000000'),
...
export const resetPasswordSchema = schema.omit(['name', 'phone_number', 'email', 'searchValue'])
