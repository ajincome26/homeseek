...
export const postSchema = yup.object({
  ...
  category: yup.string().required('Category là bắt buộc').max(200, 'Category không được vượt quá 200 ký tự'),
  price: yup.number().required('Price là bắt buộc').max(20, 'Price không được vượt quá 20 ký tự'),
  acreage: yup.number().required('Acreage là bắt buộc').max(20, 'Acreage không được vượt quá 20 ký tự'),
  deposit: yup.number().required('Deposit là bắt buộc').max(20, 'Deposit không được vượt quá 20 ký tự'),
  target: yup.string().required('Target là bắt buộc').max(20, 'Target không được vượt quá 20 ký tự'),
  medias: yup.array().of(yup.string()).required('Medias là bắt buộc')
})
