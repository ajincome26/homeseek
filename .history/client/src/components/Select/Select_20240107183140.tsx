...
export interface SelectProps<TFieldValues extends FieldValues> extends InputHTMLAttributes<HTMLInputElement> {
  provinces: Province[]
}

const Select = <TFieldValues extends FieldValues = FieldValues>({ provinces }: SelectProps<TFieldValues>) => {
  return (
