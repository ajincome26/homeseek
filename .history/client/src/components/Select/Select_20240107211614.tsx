...
const Select = ({ type, provinces, districts, value, setValue, label, optionTitle }: SelectProps) => {
  return (
    <div className='flex flex-col gap-2 basis-[30%]'>
      ...
      <select
        ...
        value={value}
        onChange={(e) => setValue(e.target.value)} // value của select là value của option (ở đây là id)
      >
