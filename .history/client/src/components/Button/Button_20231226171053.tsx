    ...
    return (
      <Link to={to || ''}>
        <button
          type={type || 'button'}
          disabled={isLoading}
          className={`${className} flex items-center justify-center font-medium text-white transition duration-300 ease-linear bg-auto rounded-md bg-gradient-to-br hover:opacity-90 from-third to-fourth hover:bg-gradient-to-tl focus:ring-4 focus:outline-none focus:ring-teal-300`}
          {...rest}
        >
          {isLoading ? (
