...
const InputNumber = forwardRef<HTMLInputElement, InputNumberProps>(function InputNumberInner(
  { className, onChange, value = '', unit, rounded, ...rest },
  ref
) {
    ...
    <div className='w-full'>
      <div className='flex'>
        <input
          ...
          className={`px-3 py-2 border-[2px] border-[#a0c7d6] outline-none focus:border-[#4b5fc2] cr-transition box-border flex-1 ${
