        ...
        {post.medias.length < 4 &&
          Array(4 - post.medias.length)
            ...
            .map((item) => (
              <img
                key={v4()}
                src='https://img.freepik.com/free-photo/abstract-surface-textures-white-concrete-stone-wall_74190-8189.jpg?size=626&ext=jpg&ga=GA1.1.1448711260.1706313600&semt=ais'
                alt='preview'
