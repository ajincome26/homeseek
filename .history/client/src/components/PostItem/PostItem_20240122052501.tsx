...
const PostItem = ({ address, attributes, description, images, star, title, user, id }) => {
    ...
    <div className='relative flex w-full gap-2 pt-3 my-3 border-t border-t-red-600'>
      ...
      >
        ...
        {images.length > 0 &&
          images
            ...
            ?.map((i, index) => <img key={index} src={i} alt='preview' className='object-cover w-full h-[127px]' />)}
        {/* Có thể dùng cách 2 */}
      ...
      <div className='flex flex-col w-3/5'>
        ...
        <div className='flex items-center justify-between my-[10px]'>
          <span className='font-semibold text-secondary basis-2/6'>{attributes?.price}</span>
