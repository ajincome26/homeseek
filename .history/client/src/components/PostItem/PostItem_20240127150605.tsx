  ...
  return (
    <div className='relative flex w-full gap-2 pt-3 my-3 border-t border-t-red-600'>
      ...
      <div className='flex flex-col w-3/5'>
        <div className='flex font-semibold text-red-600 uppercase rounded-sm cursor-pointer cr-hover-text-red hover:bg-slate-300'>
          <span className='flex items-center h-6 transition cursor-pointer hover:opacity-80'>
