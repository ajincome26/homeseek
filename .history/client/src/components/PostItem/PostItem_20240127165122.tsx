...
import { v4 } from 'uuid'
import { Post, PostWithUser } from '~/types/post.type'
        ...
        <div className='flex items-center justify-between mt-auto'>
          <div className='flex items-center basis-1/2'>
            <div className='mr-2 overflow-hidden rounded-full'>
              <img src={defaultURL} alt='' className='w-[30px] h-[30px] object-cover' />
            </div>
            <span className='font-semibold'>{user.[0].username}</span>
          </div>
